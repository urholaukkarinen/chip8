...
export class Chip8 {
    ...
    */
    load(rom) {
        try {
            ...
            wasm.chip8_load(retptr, this.ptr, ptr0, len0);
    ...
    */
    set_pressed_key(key, pressed) {
        wasm.chip8_set_pressed_key(this.ptr, key, pressed);
    }
    /**
    */
    tick() {
        wasm.chip8_tick(this.ptr);
    }
    /**
    * @returns {number}
    */
    display_data() {
        var ret = wasm.chip8_display_data(this.ptr);
        return ret;
    }
}
